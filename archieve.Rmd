...
df_results1 <- as.data.frame(t(sapply(colnames(df)[32:43], do_regression)))
df_results2 <- as.data.frame(t(sapply(colnames(df)[32:43], do_regression2)))
df_results3 <- as.data.frame(t(sapply(colnames(df)[32:43], do_regression3)))
df_results4 <- as.data.frame(t(sapply(colnames(df)[32:43], do_regression4)))
df_results5 <- as.data.frame(t(sapply(colnames(df)[32:43], do_regression5)))
df_results6 <- as.data.frame(t(sapply(colnames(df)[32:43], do_regression6)))
df_results7 <- as.data.frame(t(sapply(colnames(df)[32:43], do_regression7)))
df_results8 <- as.data.frame(t(sapply(colnames(df)[32:43], do_regression8)))
