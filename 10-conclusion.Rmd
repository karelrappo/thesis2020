...
Secondly, we accept our second hypothesis that the model based on full sample is inefficient in predicting GDP during turbulent periods - this is because business cycle-related asymmetries exist. As mentioned in the results, having calculated two business cycle dependent RMSFE’s (in addition to the general RMSFE), we can clearly note that the RMSFE is higher during the recessionary period, no matter the model used.
