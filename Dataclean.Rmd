...
df_summary <- dataset %>%
  select("YIV", "GDP", "CON", "EMP", "IND", "spy_logreturn","VIX","DBAA","AAA","baa_aaa","gz_spr", "housng" , "SRT03M", "TRM1003", "TRM1006", "TRM1012", "TRM0503", "TRM0506")

#standardize only independent + spy(since log) <-- SISESTA SIIA NEED MIDA POLE VAJA STANDARDIZEDA
standardizable_var <- setdiff(ls(dataset), c("GDP", "CON", "EMP", "IND","spy_logreturn", "dum", "Date","log_gdp"))
