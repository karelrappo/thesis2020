...
df <- df %>%
  ...
  mutate(lag6=lag(log_gdp, n = 6L)) %>%
  mutate(lag8=lag(log_gdp, n = 8L)) %>%
  mutate(lag10=lag(log_gdp, n = 10L)) %>%
  mutate(lag12=lag(log_gdp, n = 12L)) %>%
  mutate(lag14=lag(log_gdp, n = 14L)) %>%
  mutate(lag16=lag(log_gdp, n = 16L)) %>%
  mutate(lag18=lag(log_gdp, n = 18L)) %>%
  mutate(lag20=lag(log_gdp, n = 20L))
