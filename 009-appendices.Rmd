...
statistics <- t(cbind(t(statistics_GDP[nrow(statistics_GDP):1,]), t(statistics_dependent) ,t(statistics_vix),t(statistics_housng)))
  ...
  kable_styling(latex_options = c("striped","repeat_header")) %>%
    pack_rows("Panel A: YIV",1,1, latex_align="c") %>%
      pack_rows("Panel B: Dependent Variables",2,5, latex_align="c") %>%
        pack_rows("Panel C: Control Variables",6,7, latex_align="c") %>%
