...
#grangertest(log_gdp ~ YIV, order=3, df)
```
\newpage
## Appendix E. 
...
# lag_selection1 <- lm(log_gdp ~ lag4, df)
# lag_selection2 <- lm(log_gdp ~ lag4+lag6, df)
# lag_selection3 <- lm(log_gdp ~ lag4+lag6+lag8, df)
# lag_selection4 <- lm(log_gdp ~ lag4+lag6+lag8+lag10, df)
# lag_selection5 <- lm(log_gdp ~ lag4+lag6+lag8+lag10+lag12, df)
# lag_selection6 <- lm(log_gdp ~ lag4+lag6+lag8+lag10+lag12+lag14, df)
# lag_selection7 <- lm(log_gdp ~ lag4+lag6+lag8+lag10+lag12+lag14+lag16, df)
# 
...
regr3 <- regrs(mudelid=c("YIV", "lag4", "lag6"))
...
regr4 <- regrs(mudelid=c("lag4", "lag6", "lag8", "lag10", "lag12", "DGS1", "DGS10", "DGS5", "DGS3MO", "TRM0503","TRM0506","TRM1003","TRM1006","TRM1012", "SRT03M", "AAA", "DBAA", "VIX", "housng"))
...
regr5 <- regrs(mudelid=c("YIV", "dum", "lag4", "lag6", "lag8", "lag10", "lag12", "DGS1", "DGS10", "DGS5", "DGS3MO", "TRM0503","TRM0506","TRM1003","TRM1006","TRM1012", "SRT03M", "AAA", "DBAA", "VIX", "housng"))
