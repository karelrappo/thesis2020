...
plot(variable_importance("F1"), main = "H1", xlab = "")
plot(variable_importance("F2"), main = "H2", xlab = "")
plot(variable_importance("F4"), main = "H4")
plot(variable_importance("F8"), main = "H8")
