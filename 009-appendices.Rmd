...
```{r rfjoonised, message=F, warnings=F, fig.height=3, fig.width=6, fig.cap="Random Forest RMSFEs"}



ggplot(rf_resultss2, aes(as.numeric(time), value)) + geom_line(aes(colour = series))



ggplot(rf_resultss3, aes(time, value)) + geom_line(aes(colour = series))



ggplot(rf_resultss4, aes(time, value)) + geom_line(aes(colour = series))
