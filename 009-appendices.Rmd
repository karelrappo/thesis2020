...
regr4 <- regrs(mudelid=c("DGS1","TRM1012", "SRT03M", "baa_aaa", "VIX", "housng", "gz_spr", "spy_logreturn"),interaction=F)
...
```{r, rmsfegraph, message = F, warnings = F,echo = F, fig.cap="Out-of-sample RMSFE for various estimations"}
...
**The dependent variable CFG-paper is where $GDP_{t+j}$ is the GDP year-on-year growth rate in quarter $t+j$.**
