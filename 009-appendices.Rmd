...
```{r message = F, warnings = F,echo = F, fig.height=2, fig.cap="Cumulative sum of squared forecast error differential (Random forest model vs benchmark historic mean model"}
CSSFED_plot("hist_rf")
```
