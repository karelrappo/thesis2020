...
regr4 <- regrs(mudelid=c("lag1", "lag2", "DGS1","TRM1012", "SRT03M", "AAA", "baa_aaa", "VIX", "housng", "gz_spr", "spy_logreturn"))
...
model5 <- lm(log_gdp ~ YIV + dum + YIV*dum + lag1 + lag2 + DGS1 + TRM1012 + SRT03M + baa_aaa + VIX + housng + gz_spr + spy_logreturn, df)
ols_vif_tol(model5)
