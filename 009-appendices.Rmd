...
```{r message = F, warnings = F,echo = F, fig.cap="Cumulative sum of squared forecast error differential (gray shaded areas represent reccesionary periods"}
ggplot(data = test, aes(x=Date,y=OOS)) + geom_point(colour='red') + 
