...
regr4 <- regrs(mudelid=c("YIV", "dum", "DGS1", "TRM1012", "SRT03M", "baa_aaa", "VIX", "housng", "gz_spr", "spy_logreturn"),interaction=F)
...
```{r pred_vs_actual_rf, message = F, warnings = F,echo = F, fig.cap="Predicted vs actual results (Random forest)"}
...
```{r RSMFE_lm_vs_rf, message = F, warnings = F,echo = F, fig.cap="RMSFE-s of linear model and random forest"}
...
```{r squared_errors, message = F, warnings = F,echo = F, fig.cap="Squared errors"}
