...
credit.raw <- read_csv("Data/GZ_quarterly.csv")
credit.raw$date <- as.Date(as.yearqtr(credit.raw$date, format = "%YQ%q"))
credit.clean <- subset(credit.raw, date >= start & date <=end)
