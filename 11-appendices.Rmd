...
The following table displays out-of-sample RMSFEs for various estimations. Naive is a panel with only log_gdp, TRM is a panel with all of the term spreads, CRS is a panel with credit spreads and credit yields. Full model includes all of the variables: YIV, dummy, log_gdp, TRM1003, TRM1006, TRM1012, TRM0506, AAA, DBAA, baa_aaa, DGS3MO, SRT0
...
The figure below depicts squared errors for both models across all of the forecast horizons. Squared errors have been calculated as the squared differences of actual and predicted values.
