...
df_results <- rbind(df_results1, df_results2, df_results3, df_results4)
...
rownames(df_results) <- c("Out-of-sample RMSFE", "In-sample RMSFE", "Out-of-sample expansionary RMSFE", "Out-of-sample recessionary RMSFE")
