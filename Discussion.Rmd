...
Our results are consistent with the paper by Cremers et al. (2017) while the only difference that arises is from std. error. Thus, this verifies the validity of our methodology and that the extracted data can be used to proceed with the research process.
